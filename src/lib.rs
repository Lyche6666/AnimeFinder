...
#[derive(Debug)]
pub struct AnimeFinderProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AnimeFinderProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AnimeFinder processing");
    
    let mut processor = AnimeFinderProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AnimeFinderProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AnimeFinderProcessor::new(false);
